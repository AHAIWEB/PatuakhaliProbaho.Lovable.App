...
const Auth = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isForgotPassword) {
        ...
        toast({ title: "সফল", description: "পাসওয়ার্ড রিসেট লিংক পাঠানো হয়েছে" });
        ...
        if (error) throw error;
        toast({ title: "সফল!", description: "অনুগ্রহ করে ইমেইল যাচাই করুন" });
      }
    } catch (error: any) {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (result?.error) toast({ title: "ত্রুটি", description: String(result.error), variant: "destructive" });
  };
      ...
      <div className="container mx-auto px-4 py-12 flex justify-center">
        <Card className="w-full max-w-md shadow-lg border-t-4 border-t-primary">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-bold">আমাদের পরিবার</CardTitle>
            <CardDescription>
              {isForgotPassword
